...
const page = {
  ...
  popup: {
    ...
    fieldIcon: document.querySelector(".popup__form input[name='icon']"),
  },
};
  ...
  for (const index in activeHabbit.days) {
    ...
    element.innerHTML = `
      ...
      <button class="habbit__delete" onclick="removeDays(${index})">
          <img src="images/delete.svg" alt="Удалить задачу ${index + 1}">
      </button>    
    `;
...
function setIcon(context, icon) {
  page.popup.fieldIcon.value = icon;
